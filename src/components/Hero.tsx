...
export default function Hero() {
  ...
  return (
    <main className="min-h-[100vh] max-w-full">
        ...
        <nav className="relative py-6 mb-12 md:mb-20 bg-transparent z-50">
          <div className="container px-4 mx-auto">
            <div className="flex items-center">
              <Link
                className="hidden lg:inline-block text-lg font-bold"
                href="/"
              >
                <Image
                  className="h-10"
              ...
              <Link
                className="inline-block lg:hidden text-lg font-bold"
                href="/"
              >
                <Image
                  className="h-10"
                  ...
                  <div className="md:flex mb-14 max-w-xs sm:max-w-sm md:max-w-none">
                    ...
                    <div className="max-w-md">
                      <p className="md:text-xl text-gray-600 font-semibold">
                        ...
                        top NFT collection showcase and share it with your
                        frends. Simply create, grow and earn!
                      </p>
                    </div>
                  </div>
